...
const HealthDashboardScreen = ({ darkMode, onComplete, lang = 'ru', locations = [], currentPosition, steps, calories, weather }) => {
 ...
 const t = {
     ...
     hy: {
         ...
         weatherTitle: "Եղանակը հիմա", nearbyTitle: "Հետաքրքիր մոտակայքում",
         meters: "մ", km: "կմ", btn: "Սկսել ուսումնասիրել",
         noData: "Սկսեք քայլել — տվյալները կհայտնվեն", loading: "Որոշվում է ձեր գտնվելու վայրը..."
     },
     hi: {
         greeting: getGreeting(), subtitle: "आपका दिन गति में",
         steps: "कदम", calories: "कैलोरी", of: "में से", kcal: "कैलोरी", goal: "लक्ष्य",
         forecast: "आज का अनुमान", forecastSteps: "दिन के अंत तक कदम",
         weatherTitle: "अभी मौसम", nearbyTitle: "आसपास की दिलचस्प जगहें",
...
const TRANSLATIONS = {
    ru: {
        ...
        notif_later: "Позже",
       city_kemerovo: "Кемерово", city_moscow: "Москва", city_yerevan: "Ереван", city_dusseldorf: "Дюссельдорф", city_bremen: "Бремен", city_arambol: "Арамболь", city_pitsunda: "Пицунда", city_dortmund: "Дортмунд",
...
const getEmptyStructure = () => ({
    ...
    if (cityId === 'kemerovo') {
        ...
        const s_bor = { name: "Сосновый Бор", distance: 5.5, time: "60 мин", difficulty: "Сложная", image: "https://archive.org/download/sb_20260220/sb.jpg", audioUrl: "https://archive.org/download/sb_20260220/sb.MP3", geoUrl: "https://yandex.com/maps/-/CPanVZ31", location: { lat: 55.378308, lon: 86.104392 }, descriptionShort: "Самый большой в мире хвойный городской парк!", subCategory: "Природные зоны и парки", explicitDate: "2026-02-19", videoUrl: "" };
        const mmuz = { name: "МиТОК — стройка, которую все видели, но никто не знает", distance: 0.5, time: "10 мин", difficulty: "Лёгкая", image: "https://archive.org/download/m1_20260226/m1.png", audioUrl: "https://archive.org/download/m1_20260226/1.MP3", geoUrl: "https://yandex.com/maps/-/CPeSrGpJ", location: { lat: 55.351509, lon: 86.100853 }, descriptionShort: "Мировой рекорд прямо в центре Кемерова", subCategory: "Музеи и выставки", explicitDate: "2026-02-27", videoUrl: "https://rutube.ru/video/cf7e0d0c483280763d4ec451fb241f0a/" };
        const eli = { name: "Елыкаево-Кузбасс факты о которых вы не знали!", distance: 25, time: "120 мин", difficulty: "Сложная", image: "https://archive.org/download/elikaevo/1.png", audioUrl: "https://archive.org/download/elikaevo/elikaevo.MP3", geoUrl: "https://yandex.com/maps/-/CPukRCiz", location: { lat: 55.301100, lon: 86.257060 }, descriptionShort: "Село 1800 года!", subCategory: "Музеи и выставки", explicitDate: "2026-03-08", videoUrl: "https://rutube.ru/video/a7ada5bb55d661862fb1c7fe66c04f97/" };
        const svist = { name: "Святой источник преподобного Серафима Саровского ", distance: 5, time: "60 мин", difficulty: "Сложная", image: "https://archive.org/download/sv_istochnik/23454.jpeg", audioUrl: "https://archive.org/download/sv_istochnik/sv_istochnik.MP3", geoUrl: "https://yandex.com/maps/-/CPf75Vkt", location: { lat: 55.379137, lon: 86.088940 }, subCategory: "Церкви и храмы",  descriptionShort: "Святой источник преподобного Серафима Саровского в Сосновом бору Кемерова", subCategory: "", explicitDate: "2026-04-06", videoUrl: "https://rutube.ru/video/e33695b51bb32d21c4a255ce7d90917b/?r=wd" };
        const filar = { name: "Государственная филармония Кузбасса", distance: 1, time: "10 мин", difficulty: "Лёгкая", image: "https://archive.org/download/filarmony/Filharmonio_en_Kemerovo.jpg", audioUrl: "https://archive.org/download/filarmony/filarmony.MP3", geoUrl: "https://yandex.ru/maps/-/CPCru4o4", location: { lat: 55.353329, lon: 86.094416 }, subCategory: "Музыкальные маршруты", descriptionShort: "Государственная филармония Кузбасса имени Бориса Штоколова", subCategory: "", explicitDate: "2026-04-20", videoUrl: "https://rutube.ru/video/98c3e4106ce74ac28f12149488d20d99/" };
        const pristan = { name: "Пристань-могила", distance: 1, time: "20 мин", difficulty: "Лёгкая", image: "https://archive.org/download/pristan_202604/scale_1200.jpg", audioUrl: "https://archive.org/download/pristan_202604/pristan.MP3", geoUrl: "https://yandex.com/maps/-/CPCHiTPb", location: { lat: 55.376020, lon: 86.063089 }, descriptionShort: "Красная горка. Гора горелая", subCategory: "Легенды и мифы города", explicitDate: "2026-04-22", videoUrl: "https://rutube.ru/video/fc544587c4c09346afaf9c25543557b1/" };
...
curatedInteresting = [erFactsYerevan];
        ...
        structure["Культурные и исторические маршруты"]["Музеи и выставки"] = [erevFountains, cascadeRoute, levonCave];
        structure["Культурные и исторические маршруты"]["Памятники и мемориалы"] = [erevFountains, cascadeRoute];
        structure["Культурные и исторические маршруты"]["Архитектурные достопримечательности"] = [kondQuarter, levonCave, erebuniFortress, erevFountains, erevFountainRepublic, cascadeRoute];
        ...
        structure["Тематические маршруты"]["Мифы и легенды"] = [khorVirap, erevFountains, cascadeRoute, levonCave];
...
curatedInteresting = [br_m ];
        ...
        // === Культурные и исторические маршруты ===
        structure["Культурные и исторические маршруты"]["Набережная"] = [br_m];
        structure["Культурные и исторические маршруты"]["Музеи и выставки"] = [br_m];
        structure["Культурные и исторические маршруты"]["Памятники и мемориалы"] = [br_m];
        structure["Культурные и исторические маршруты"]["Архитектурные достопримечательности"] = [br_m];
        structure["Культурные и исторические маршруты"]["Городские площади"] = [br_m];
        structure["Культурные и исторические маршруты"]["Исторические кварталы"] = [br_m];
        structure["Культурные и исторические маршруты"]["Церкви и храмы"] = [br_m];
        structure["Культурные и исторические маршруты"]["Легенды и мифы города"] = [br_m];

        // === Природные и активные маршруты ===
        structure["Природные и активные маршруты"]["Природные зоны и парки"] = [br_m];
        structure["Природные и активные маршруты"]["Горные и лесные маршруты"] = [br_m];
        structure["Природные и активные маршруты"]["Активный отдых у воды"] = [br_m];
        structure["Природные и активные маршруты"]["Спортивные площадки и фитнес-парки"] = [br_m];

        // === Современные и урбанистические маршруты ===
        structure["Современные и урбанистические маршруты"]["Скульптуры и уличное искусство"] = [br_m];
        structure["Современные и урбанистические маршруты"]["Современная архитектура"] = [br_m];
        structure["Современные и урбанистические маршруты"]["Городские лаборатории"] = [br_m];
        structure["Современные и урбанистические маршруты"]["Реставрации и обновления"] = [br_m];

        // === Гастрономические маршруты ===
        structure["Гастрономические маршруты"]["Кофе"] = [br_m];
        structure["Гастрономические маршруты"]["Уличная еда"] = [br_m];
        structure["Гастрономические маршруты"]["Традиционные рестораны"] = [br_m];
        structure["Гастрономические маршруты"]["Гастрономические мастер-классы"] = [br_m];

        // === Семейные маршруты ===
        structure["Семейные маршруты"]["Парки аттракционы и детские площадки"] = [br_m];
        structure["Семейные маршруты"]["Зоопарки"] = [br_m];
        structure["Семейные маршруты"]["Музеи для детей"] = [br_m];
        structure["Семейные маршруты"]["Пикники на природе"] = [br_m];
        structure["Семейные маршруты"]["Игровые центры и развлекательные зоны"] = [br_m];

        // === Альтернативные маршруты ===
        structure["Альтернативные маршруты"]["Заброшенные здания и территории"] = [br_m];
        structure["Альтернативные маршруты"]["Урбанистические исследования"] = [br_m];
        structure["Альтернативные маршруты"]["Тайные и мистические маршруты"] = [br_m];
        structure["Альтернативные маршруты"]["Ночные экскурсии"] = [br_m];

        // === Тематические маршруты ===
        structure["Тематические маршруты"]["Музыкальные маршруты"] = [ br_m];
        structure["Тематические маршруты"]["Кино и телевидение"] = [br_m];
        structure["Тематические маршруты"]["Мифы и легенды"] = [br_m];
        structure["Тематические маршруты"]["Технические и инновационные маршруты"] = [br_m];
        structure["Тематические маршруты"]["Спортивные маршруты"] = [br_m];
...
const florianturm = { name: "Флориантурм — первая вращающаяся башня в мире", distance: null, time: "5 мин", difficulty: "Лёгкая", image: "https://archive.org/download/florianturm/Florianturm_bei_Nacht.jpg", audioUrl: "https://archive.org/download/florianturm/florianturm.MP3", videoUrl: "https://youtu.be/-OSFfi_quDU", geoUrl: "https://maps.app.goo.gl/tjYL8ZVwsDpgx7zW6", location: { lat: 51.496278, lon: 7.476722 }, descriptionShort: "Флориантурм — телебашня высотой 211 метров и символ Дортмунда. Построена за неполный год в 1959 году. Первая в мире телебашня с вращающимся рестораном. Со смотровой площадки на высоте 142 метров открывается панорама всего Рурского региона.", subCategory: "Архитектурные достопримечательности" };
    ...
    structure["Культурные и исторические маршруты"]["Памятники и мемориалы"] = [florianturm];
    structure["Культурные и исторические маршруты"]["Архитектурные достопримечательности"] = [dortmundFacts, florianturm];
    ...
    structure["Современные и урбанистические маршруты"]["Современная архитектура"] = [florianturm];
    ...
    structure["Гастрономические маршруты"]["Традиционные рестораны"] = [florianturm];
    structure["Гастрономические маршруты"]["Гастрономические мастер-классы"] = [];

    // === СЕМЕЙНЫЕ (5 подкатегорий) ===
    structure["Семейные маршруты"]["Парки аттракционы и детские площадки"] = [florianturm];
    ...
    structure["Альтернативные маршруты"]["Урбанистические исследования"] = [florianturm, dortmundFacts];
